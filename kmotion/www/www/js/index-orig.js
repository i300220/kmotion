...
KM.conf_feed_html = function(camera) {
    ...
    '<div style="float:left; width:110px;" class="config_text_basic margin_top_4px">' +
        '<select id="feed_device" onchange="KM.conf_feed_net_highlight();" disabled>' +
            '<option value="0">/dev/cam0</option>' +	
            '<option value="1">/dev/cam1</option>' +	
            '<option value="2">/dev/cam2</option>' +	
            '<option value="3">/dev/cam3</option>' +	
            '<option value="4">/dev/cam4</option>' +	
            '<option value="5">/dev/cam5</option>' +	
            '<option value="6">/dev/cam6</option>' +	
            '<option value="7">/dev/cam7</option>' +	
            '<option value="8">/dev/cam8</option>' +	
            '<option value="9">/dev/cam9</option>' +	
            '<option value="10">/dev/cam10</option>' +	
            '<option value="11">/dev/cam11</option>' +	
            '<option value="12">/dev/cam12</option>' +	
            '<option value="13">/dev/cam13</option>' +	
            '<option value="14">/dev/cam14</option>' +	
            '<option value="15">/dev/cam15&nbsp;</option>' +	
