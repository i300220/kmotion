...
"""
PT(Z) driver for axis 213 network camera
"""
...
URL_CGI_X = '/axis-cgi/com/ptz.cgi?camera=1&panbar=194,horisontal&barcoord='
URL_CGI_Y = '/axis-cgi/com/ptz.cgi?camera=1&tiltbar=174,vertical&barcoord='
